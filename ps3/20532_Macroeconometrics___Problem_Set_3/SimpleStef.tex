...
\usepackage[backend=biber,
            style=numeric,          % options: numeric, verbose, authoryear, authorname
...
% Warning with a BurntOrange bar
\theoremstyle{theorem}
...
\tcolorboxenvironment{warning}{
  ...
  colback={White},
  enhanced jigsaw,
  borderline west={1pt}{0pt}{BrickRed},
  before skip=10pt,
  after skip=10pt,
  sharp corners,
  left=5pt,
...
% =============================================================================
%  CODE, ALGORITHM & PSEUDOCODE LISTINGS
% =============================================================================
